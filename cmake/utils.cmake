  ...
  foreach (fil ${ARGN})
    ...
    if (rIdx EQUAL 0)
      ...
      if (rIdx EQUAL -1)
        ...
        source_group("${fileGroup}" REGULAR_EXPRESSION "${filePath}/[^/]+.(cpp|h|cc|hpp|ipp|c)$")
      endif()
    endif()
  endforeach()
endfunction()
...
macro(utils_add_executable target_name folder_name)
    add_executable(${target_name} ${ARGN})
    set_target_properties(${target_name} PROPERTIES FOLDER ${folder_name})
endmacro(utils_add_executable target_name folder_name)

macro(utils_add_library target_name folder_name)
    add_library(${target_name} ${ARGN})
    set_target_properties(${target_name} PROPERTIES FOLDER ${folder_name})
endmacro(utils_add_library target_name folder_name)
